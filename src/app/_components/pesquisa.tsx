...
export const Pesquisa = () => (
  <section id="pesquisa" className="w-full flex justify-center">
    <div className="max-w-3xl w-full px-6 py-10 mx-auto bg-white/90">
      <h2 className="text-3xl font-bold mb-4 text-pink-700">Como Identificar Relacionamentos Tóxicos e Saudáveis</h2>
      <h3 className="text-xl font-semibold mb-2 text-gray-800">Por que Muitas Mulheres Permanecem e Como a Sociedade Romantiza a Toxicidade</h3>
      <p className="mb-4 text-gray-700">
        Na sociedade atual, a cada dia que passa, o que mais aparece nos portais de informações são notícias envolvendo mulheres de forma trágica.
  <span className="block font-semibold text-pink-700 mt-2">Em 2023, o Brasil registrou mais de 1.400 casos de feminicídio, segundo o Fórum Brasileiro de Segurança Pública.</span>
      ...
      <div className="mb-4 bg-gray-100 p-4 rounded">
        ...
        <ul className="list-disc pl-5 text-gray-700">
          <li>“a gente fica meio perdida, desanimada”</li>
          <li>“Me senti horrível, a pior das mulheres, você se sente um lixo. Um lixo, um lixo, um lixo, a cada dia pior. Eu me olhava no espelho, não era mais eu” (abuso psicológico)</li>
          <li>“Eu gostava dele né? Gostava, ou achava que gostava né? Não sei... só isso, mais nada”</li>
          <li>“Porque eu não precisava trabalhar, ele me dava de tudo mesmo preso” (dependência econômica)</li>
          <li>“Ah eu gosto muito dele, eu quero ficar com ele e, [...] eu não me vejo sem ele” (dependência emocional)</li>
        </ul>
      </div>
      <p className="mb-4 text-gray-700">
      ...
      <div className="mb-4 bg-gray-100 p-4 rounded">
        ...
        <ul className="list-disc pl-5 text-gray-700">
          <li><b>Construção das tensões:</b> controle, isolamento, ofensas, humilhações</li>
          <li><b>Explosão da violência:</b> agressão física, patrimonial, moral, sexual ou psicológica</li>
          <li><b>Lua de mel:</b> pedidos de perdão, promessas de mudança, reconciliação</li>
        </ul>
      </div>
      <p className="mb-4 text-gray-700">
